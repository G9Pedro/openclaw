        ...
        Type.Object(
          {
            ...
            goalsFile: Type.Optional(Type.String()),
            tasksFile: Type.Optional(Type.String()),
            logFile: Type.Optional(Type.String()),
            maxActionsPerRun: Type.Optional(Type.Integer({ minimum: 1, maximum: 20 })),
            dedupeWindowMinutes: Type.Optional(Type.Integer({ minimum: 1, maximum: 24 * 60 })),
            maxQueuedEvents: Type.Optional(Type.Integer({ minimum: 1, maximum: 500 })),
            dailyTokenBudget: Type.Optional(Type.Integer({ minimum: 1 })),
            dailyCycleBudget: Type.Optional(Type.Integer({ minimum: 1 })),
            maxConsecutiveErrors: Type.Optional(Type.Integer({ minimum: 1, maximum: 100 })),
            autoPauseOnBudgetExhausted: Type.Optional(Type.Boolean()),
            autoResumeOnNewDayBudgetPause: Type.Optional(Type.Boolean()),
            errorPauseMinutes: Type.Optional(Type.Integer({ minimum: 1, maximum: 24 * 60 })),
            staleTaskHours: Type.Optional(Type.Integer({ minimum: 1, maximum: 24 * 30 })),
            emitDailyReviewEvents: Type.Optional(Type.Boolean()),
            emitWeeklyReviewEvents: Type.Optional(Type.Boolean()),
          },
          { additionalProperties: false },
        ),
      ),
