...
export function buildAutonomousCoordinationPrompt(opts: AutonomousPromptOptions) {
  ...
  const lines = [
    ...
    "- DAILY_REVIEW / WEEKLY_REVIEW: perform meta-planning, prune stale goals, and update strategy.",
    "- STALE_TASK_SIGNAL: tasks can be escalated automatically when blocked/in-progress too long.",
    ...
    "7. On review cycles, explicitly record what to stop, continue, and newly attempt.",
    "8. End with NEXT_TRIGGER containing what should wake you next and why.",
    "",
    "Safety constraints:",
